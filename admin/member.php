...
<body>
    <div class="side-menu">
        ...
        <ul>
            ...
            <a href="member.php"><li class="selected"><img src="../images/user.png" alt="">&nbsp; Member</li></a>
    ...
    <div class="container">
        <div class="header">
            ...
            <h2>Admin Member</h2>
                <div class="cud">
                    <div class="user">
                        <a href="member.php?page=create_member" class="btn"><img src="../images/multiple.png   " alt="">Add Data</a>
                    </div>
